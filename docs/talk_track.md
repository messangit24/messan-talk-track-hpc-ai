# Talk Track — HPC + AI on Google Cloud

Pure bullet outline for each slide. Fill in customer-specific framing, researcher name-checks, and workload anecdotes verbally per engagement. Aero-sim live-demo segment (slide 14) is detailed in a separate [Google Doc](https://docs.google.com/document/d/1Vtz-UKe5E__SPvYQ5jkAwSdgxMVmNBtExa_NCqdNNVI/).

Target runtime: ~20 minutes. Adjust per audience.
